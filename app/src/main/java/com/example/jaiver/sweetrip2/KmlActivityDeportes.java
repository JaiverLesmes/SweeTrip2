...
public class KmlActivityDeportes extends BaseActivity implements GoogleMap.OnInfoWindowClickListener, OnMapReadyCallback {
    ...
    private void retrieveFileFromResource() {
        try {
            KmlLayer kmlLayer = new KmlLayer(mMap, R.raw.deportes, getApplicationContext());
            ...
            try {
                ...
                kmlLayer.setOnFeatureClickListener(new KmlLayer.OnFeatureClickListener() {
                    ...
                    public void onFeatureClick(Feature feature) {
                        Toast.makeText(KmlActivityDeportes.this,
