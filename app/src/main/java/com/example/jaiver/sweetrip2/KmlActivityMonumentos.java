...
public class KmlActivityMonumentos extends BaseActivity {
    ...
    private void retrieveFileFromResource() {
        try {
            KmlLayer kmlLayer = new KmlLayer(mMap, R.raw.monumentos, getApplicationContext());
            ...
            try {
                ...
                kmlLayer.setOnFeatureClickListener(new KmlLayer.OnFeatureClickListener() {
                    ...
                    public void onFeatureClick(Feature feature) {
                        Toast.makeText(KmlActivityMonumentos.this,
