...
public class KmlActivityDiscotecas extends BaseActivity implements GoogleMap.OnInfoWindowClickListener, OnMapReadyCallback {
    ...
    private void retrieveFileFromResource() {
        try {
            KmlLayer kmlLayer = new KmlLayer(mMap, R.raw.discotecas, getApplicationContext());
            //KmlLayer kmlLayer2 = new KmlLayer(mMap, R.raw.sectorespeligrosos, getApplicationContext());
            ...
            try {
                ...
                kmlLayer.setOnFeatureClickListener(new KmlLayer.OnFeatureClickListener() {
                    ...
                    public void onFeatureClick(Feature feature) {
                        Toast.makeText(KmlActivityDiscotecas.this,
